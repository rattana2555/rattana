...
export default function App(){
  const [pddt, setPddt] = useState([]);
  const [bqSales, setBqSales] = useState({});
  ...
  return(
    <div style={{fontFamily:"'Noto Sans Thai',Sarabun,Arial,sans-serif",background:S.navy,minHeight:"100vh",color:"#f0e6c8"}}>
      ...
      <div style={{background:`linear-gradient(135deg,#030a1a,${S.navy3})`,borderBottom:`2px solid ${S.gold}`,
        ...
        <div>
          <div style={{fontSize:17,fontWeight:800,color:S.gold2}}>📊 Sales & Stock Dashboard <span style={{fontSize:11,color:"#888",fontWeight:400}}>v1.0 · 2026-05-16</span></div>
